...
public class SysLogController {
	 ...
	 * 删除日志
	 */
	@com.yami.shop.common.annotation.SysLog("删除系统日志")
	@DeleteMapping
	@PreAuthorize("@pms.hasPermission('sys:log:page')")
	public ServerResponseEntity<Void> delete(@RequestBody Long[] logIds){
	 ...
	 * 清空日志
	 */
	@com.yami.shop.common.annotation.SysLog("清空系统日志")
	@DeleteMapping("/clear")
	@PreAuthorize("@pms.hasPermission('sys:log:page')")
